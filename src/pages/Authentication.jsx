    ...
    <div className="auth-section">
      ...
      >
        <h1 className="text-3xl lg:text-4xl text-blue-700">
          Welcome to SoftResume
        </h1>
        <p className="text-base text-gray-600">soft way to create resume</p>
        <h2 className="text-2xl text-gray-600">Authenticate</h2>
        <div
          className="w-full sm:w-96 rounded-md p-2 flex flex-col items-center
                justify-start gap-6"
        >
